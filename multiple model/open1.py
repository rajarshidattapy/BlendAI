...
AVAILABLE_MODELS = [
    ("nvidia/llama-3.1-nemotron-70b-instruct:free", "Llama 3.1 Nemotron 70B (Free)", "Free model with good performance"),
    ("anthropic/claude-3-opus:free", "Claude 3 Opus (Free)", "High-quality model with free tier"),
    ("anthropic/claude-3-sonnet:free", "Claude 3 Sonnet (Free)", "Balanced model with free tier"),
    ("google/gemini-1.5-pro:free", "Gemini 1.5 Pro (Free)", "Google's latest model with free tier"),
    ("meta-llama/llama-3.1-405b-instruct:free", "Llama 3.1 405B (Free)", "Large model with good performance"),
]
...
def get_generated_code(prompt):
    ...
    try:
        ...
        selected_model = bpy.context.scene.ai_model
